...
import 'package:nomba_routines/screens/homePage.dart';
          ...
          children: [
            Container(
              ...
              child: PageView(
                ...
                children: [
                  onBoardPage('onboard1', 'Welcome to Nomba Routines'),
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          padding: EdgeInsets.symmetric(vertical: 10),
          child: Text(
            "Lorem ipsum is a simply dummy text of the printing industry",
